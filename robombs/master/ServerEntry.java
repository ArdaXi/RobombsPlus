...
import java.net.UnknownHostException;
	...
	public class ServerEntry implements Comparable<ServerEntry> {
		...
		public String toString() {
			try {
				return URLEncoder.encode(name, "UTF-8")+"|"+URLEncoder.encode(addr.toString(), "UTF-8")+"|"+URLEncoder.encode(Integer.toString(port), "UTF-8")+"|"+URLEncoder.encode(Integer.toString(clients), "UTF-8");
			} catch (Exception e) {
				return null;
			}
		}

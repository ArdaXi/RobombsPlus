...
/**
 * A mesh representing a player. Instances are usually created by the ClientObjectFactory.
 */
class EnemyView extends AnimatedObject {
    ...
    static {
        // static initializer that creates a mesh blueprint and loads the textures.
        try {

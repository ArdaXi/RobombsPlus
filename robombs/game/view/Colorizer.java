...
public class Colorizer {
	...
	public synchronized void unload(FrameBuffer buffer) {
    	...
    	Collections.reverse(textures); // Reverse the order to remove the last texture first..helps the TextureManager's internals to save from memory
	...
	public synchronized void colorize(ClientObject co, LocalObject lo) {
    	...
    	// Try to color the clients in a fixed manner according to their IDs.
    	// For the bot client, this doesn't work. We have to take the objectID into
    	// calculation...this doesn't create unique colors over the rounds, but...well...

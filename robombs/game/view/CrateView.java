...
public class CrateView extends ClientObject {
	...
	public void hitByExplosion(CollisionParticipant source, LocalObject obj, DecalManager decal, CollisionEvent ce) {
		if (!isInactive()) {
			...
			if (ids!=null) {
				// The Crates on the bot client don't return those IDs...and they don't have to.
	...
	public void init(int id) {
		// This instance of LocalObject is used in the view only. The crates aren't real
...
//				 The item inherits the id from the crate, which is unique and the same on all clients.

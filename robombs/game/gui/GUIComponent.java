...
/**
 * GUIComponent is the abstract base class of a very very simple GUI system. The GUI components can't even paint
 * themselves. They are just click and type sensitive areas of the screen. But it shouldn't be too hard to add
...
public abstract class GUIComponent {
    ...
    /**
     * Sets if the component is visible or hidden. A hidden component must not react on clicks
     * or key press events.
     * @param visi true if visible, false otherwise
     */
   ...
   public GUIComponent getParent() {
    ...
    /**
     * Adds a child component to this component. A child will be rendered/processed in the context of
     * and relative to the parent. An example are buttons (=childs) displayed in a window (=parent).
     ...
     * @param mouse the MouseMapper used to process mouse events
     * @param keyMapper the KeyMapper used to process key events
     * @return boolean true, if an event occured in the context of this component or one of its child components.
     */
     ...
     * @param buffer the FrameBuffer on which to draw to
     */
